...
HD_PWD='D:/Project/SketchSystem_Multi1080p_HDMI/SketchSystem.runs/system_c_rsample_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_c_rsample_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_c_rsample_0_0.tcl
